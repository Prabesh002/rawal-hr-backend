...
from app.API.Controllers.HR.TimeLogController import router as time_log_router
...
api_router.include_router(time_log_router, prefix="/hr/time-logs", tags=["HR - Time Logs"])